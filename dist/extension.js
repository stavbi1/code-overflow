...
exports.getRelevantQuestions = void 0;
const axios_1 = __webpack_require__(3);
const getRelevantQuestions = async (query) => {
    ...
    const res = await axios_1.default.get(stackExchangeUrl, {
        params: {
            ...defaultParams,
            title: query
        }
...
exports.getRelevantQuestions = getRelevantQuestions;
...
axios.VERSION = (__webpack_require__(44).version);
...
var VERSION = (__webpack_require__(44).version);
var createError = __webpack_require__(17);
var enhanceError = __webpack_require__(14);
var defaults = __webpack_require__(12);
var Cancel = __webpack_require__(24);
...
const vscode = __webpack_require__(1);
const stackExchangeService_1 = __webpack_require__(2);
const vsCodeUtil_1 = __webpack_require__(51);
...
function activate(context) {
    ...
    let disposableSearchCommand = vscode.commands.registerCommand('code-overflow.search-stackoverflow', async () => {
        const query = (0, vsCodeUtil_1.getSelectedText)() || await vscode.window.showInputBox();
        if (query) {
            const results = await (0, stackExchangeService_1.getRelevantQuestions)(query);
